...
export default `<div style="color: #fff; position: relative;">
  <div style="text-align: center">
    ...
    <br />
    <div style="margin-top: 10px; display: inline-block;padding: 5px 10px;color: #000; border-radius: 10px; border: 2px dashed #00e;"><span style="text-decoration: underline 2px #00e; color: #00e">一键式生成图片、强大的css样式支持</span></div>    
